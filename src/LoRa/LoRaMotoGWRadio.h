...
#ifndef LORA_LORAMOTOGWRADIO_H_
#define LORA_LORAMOTOGWRADIO_H_
...
class LoRaMotoGWRadio : public FlatRadioBase {
private:
...
public:
    ...
    long LoRaMotoGWRadioReceptionStarted_counter;
    long LoRaMotoGWRadioReceptionFinishedCorrect_counter;
    simsignal_t LoRaMotoGWRadioReceptionStarted;
    simsignal_t LoRaMotoGWRadioReceptionFinishedCorrect;
};
